...
/**
 * This is the model class for table "datapromo".
 *
 * @property int $id
 ...
 * @property int $harga3
 */
class Datapromo extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['gambar1', 'nama_produk1', 'harga1', 'gambar2', 'nama_produk2' , 'harga2','gambar3', 'nama_produk3' , 'harga3' , 'hargadiskon1','hargadiskon2','hargadiskon3', 'desc1', 'desc2', 'desc3'], 'required'],
